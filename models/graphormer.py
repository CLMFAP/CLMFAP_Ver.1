...
from models.modules import init_graphormer_params, GraphormerGraphEncoder

logger = logging.getLogger(__name__)

@register_model("graphormer")
class GraphormerModel(FairseqEncoderModel):
    def __init__(self, args, encoder,graph_model="bi_graphormer"):
...
def graphormer_base_architecture(args):
    if (
        args.pretrained_model_name == "pcqm4mv1_graphormer_base"
        or args.pretrained_model_name == "pcqm4mv2_graphormer_base"
        or args.pretrained_model_name == "pcqm4mv1_graphormer_base_for_molhiv"
    ):
