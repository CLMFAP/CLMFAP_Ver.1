...
def test_with_bi_graph(
    ...
    for batch in tqdm(valid_dataloader):
        ...
        # print(bi_graph_datas.device.type)
...
if main_args.test:
    ...
    for dataset_name in ["PPBR", "Caco2"]:
        ...
        # for graph_model in ["no_bi_graph_mpnn"]:
            ...
            model_path = f"result/finetune_result/data/{dataset_name}/{graph_model}/checkpoint.ckpt"
    ...
    for dataset_name in ["PPBR","Caco2"]:
        ...
        # for graph_model in ["no_bi_graph_mpnn"]:
            ...
            # model_path = f"MY_MODEL/result/finetune_result/data/{dataset_name}_save/{graph_model}/checkpoint.ckpt"
            ensure_folder_exists(result_folder)
            ...
            if graph_model == 'bi_bi_graph_mpnn' or graph_model == 'original_bi_graph_no_mpnn' or graph_model== 'original_bi_graph_mpnn' or graph_model=='bi_bi_graph_no_mpnn':
                train(model, train_dataloader, valid_dataloader, optimizer, epochs=10, measure_name=measure_name)
            elif graph_model == 'no_bi_graph_mpnn':
                train_no_bi_graph(model, train_dataloader, valid_dataloader, optimizer, epochs=10, measure_name=measure_name)
    ...
    if main_args.graph_model == 'bi_bi_graph_mpnn' or main_args.graph_model == 'original_bi_graph_no_mpnn' or main_args.graph_model== 'original_bi_graph_mpnn' or main_args.graph_model=='bi_bi_graph_no_mpnn':
        ...
        train_no_bi_graph(model, train_dataloader, valid_dataloader, optimizer, epochs=20)
