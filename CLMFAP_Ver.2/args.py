...
def get_parser(parser=None):
    ...
    parser.add_argument("--graph_n_head", type=int, default=16, help="Graph number of heads")
    parser.add_argument("--graph_n_layer", type=int, default=12, help="Graph number of layers")   
    ...
    parser.add_argument(
        "--data_path", type=str, default="", help="path to pretrain data file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--graph_model", type=str, required=False, default="bi_graphormer"
    )
    parser.add_argument(
        "--model_path", type=str, required=False, default="bi_graphormer"
    )
    ...
    parser.add_argument("--skip_modal", type=str, required=False, default="no_skip")

    parser.add_argument("--bra_size", type=int, required=False, default=7)

    parser.add_argument("--fp_radius", type=int, required=False, default=2)

    
    parser.add_argument("--loss_function", type=str, required=False, default="nt_xent")
