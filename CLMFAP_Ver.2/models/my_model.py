...
class GraphEncoder(nn.Module):
    ...
    def __init__(self, config=None,graph_model="bi_graphormer", bra_size=7, graph_n_head=16, graph_n_layer=12):
        super().__init__()
        ...
        args.encoder_layers = graph_n_layer
        args.encoder_attention_heads = graph_n_head
